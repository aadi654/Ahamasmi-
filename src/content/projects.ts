...
const projects: Project[] = [
  ...
  },
  {
    ...
    title: "Dancing Voids",
    category: "bim",
    coverImage: "/projects/bim/dancing-voids/cover.webp",
    coverAlt: "BIM visualization for Dancing Voids",
    coverWidth: 1198,
    coverHeight: 914,
    gallery: [
      {
        src: "/projects/bim/dancing-voids/cover.webp",
        alt: "BIM visualization for Dancing Voids",
        width: 1198,
        height: 914,
      },
    ],
  ...
  {
    id: "shri-lakshmi-facility",
    slug: "shri-lakshmi-facility",
    title: "Shri Lakshmi Facility",
    category: "bim",
    coverImage: "/projects/bim/shri-lakshmi-facility/cover.webp",
    coverAlt: "BIM visualization for Shri Lakshmi Facility",
    coverWidth: 2933,
    coverHeight: 1650,
    gallery: [
      {
        src: "/projects/bim/shri-lakshmi-facility/01.webp",
        alt: "BIM visualization for Shri Lakshmi Facility",
        width: 2933,
        height: 1650,
      },
    ],
  ...
  {
    id: "pedestrian-arch-bridge",
    slug: "pedestrian-arch-bridge",
    title: "Pedestrian Arch Bridge",
    category: "bim",
    coverImage: "/projects/bim/pedestrian-arch-bridge/cover.webp",
    coverAlt: "BIM visualization for Pedestrian Arch Bridge",
    coverWidth: 1280,
    coverHeight: 720,
    gallery: [
      {
        src: "/projects/bim/pedestrian-arch-bridge/01.webp",
        alt: "BIM visualization for Pedestrian Arch Bridge",
        width: 2933,
        height: 1390,
      },
      {
        src: "/projects/bim/pedestrian-arch-bridge/02.webp",
        alt: "BIM visualization for Pedestrian Arch Bridge",
        width: 2931,
        height: 1544,
      },
      {
        src: "/projects/bim/pedestrian-arch-bridge/03.webp",
        alt: "BIM visualization for Pedestrian Arch Bridge",
        width: 1676,
        height: 1649,
      },
      {
        src: "/projects/bim/pedestrian-arch-bridge/04.webp",
        alt: "BIM visualization for Pedestrian Arch Bridge",
        width: 1727,
        height: 1650,
      },
      {
        src: "/projects/bim/pedestrian-arch-bridge/05.webp",
        alt: "BIM visualization for Pedestrian Arch Bridge",
        width: 2505,
        height: 1650,
      },
  ...
  {
    id: "integrated-building-services-bim",
    slug: "integrated-building-services-bim",
    title: "Integrated Building Services BIM",
    category: "bim",
    coverImage: "/projects/bim/integrated-building-services-bim/cover.webp",
    coverAlt: "BIM visualization for Integrated Building Services BIM",
    coverWidth: 2174,
    coverHeight: 1650,
    gallery: [
      {
        src: "/projects/bim/integrated-building-services-bim/01.webp",
        alt: "BIM visualization for Integrated Building Services BIM",
        width: 1185,
        height: 737,
      },
    ],
